...
class AssignmentTest {
    ...
    public void testMultiplyNumbers(){
        assertTrue(assignment.multiplyNumbers(1,2,4)==8);
        assertTrue(assignment.multiplyNumbers(2,2,10)==40);
    }

    @Test
    public void testFindBitStrength(){
        assertTrue(assignment.findBitStrength(36,8)==41.3594000115385);
        assertTrue(assignment.findBitStrength(4,4)==8);
    }
}